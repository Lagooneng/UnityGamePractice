    ...
    void Start()
    {
        ...
        foreach( SpriteRenderer sprite in spriteList )
        {
            ...
            if( sprite.name == "Filter_Paper" ||
                ...
                sprite.name == "StageA_RoadUnder_L2" ||
            ...
            if( shadowOn )
            {
                ...
                if( sprite.sortingLayerName == "ObjectFront" || sprite.sortingLayerName == "Object" )
                {
                ...
                if( sprite.name == "StageB_Floor_L" || sprite.name == "StageB_FloorUnder_B" )
                {
                    spriteCopy.sortingOrder += -10;
                }
            }
